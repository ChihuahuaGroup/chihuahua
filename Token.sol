...
contract Chihuahua is Context, IBEP20, Ownable {
    ...
    string  private _SYMBOL = 'CHIHUA';
    uint8   private _DECIMALS = 8;
   
    uint256 private constant _MAX = ~uint256(0);
    uint256 private _DECIMALFACTOR = 10 ** uint256(_DECIMALS);
    
    uint256 private _tTotal = 999000000000000 * _DECIMALFACTOR;
    ...
    uint256 private _MAX_TX_SIZE = 90000000000000 * _DECIMALFACTOR;
